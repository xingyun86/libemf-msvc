...
#include <climits>
#include <functional>
#include <emf_byteswap.h>

#include "libemf.h"

#ifdef _MSC_VER
template <int> struct TIntegerForSize;
template <>    struct TIntegerForSize<1> { typedef uint8_t  Unsigned; typedef int8_t  Signed; };
template <>    struct TIntegerForSize<2> { typedef uint16_t Unsigned; typedef int16_t Signed; };
template <>    struct TIntegerForSize<4> { typedef uint32_t Unsigned; typedef int32_t Signed; };
template <>    struct TIntegerForSize<8> { typedef uint64_t Unsigned; typedef int64_t Signed; };
#if defined(T_CC_GNU) && defined(__SIZEOF_INT128__)
template <>    struct TIntegerForSize<16> { __extension__ typedef unsigned __int128 Unsigned; __extension__ typedef __int128 Signed; };
#endif
...
#define my__builtin_smul_overflow(v1,v2,r) T_MulOverflow<int>(v1,v2,r)
#else
#define my__builtin_smul_overflow __builtin_smul_overflow
#endif
...
extern "C" {
   ...
   */
  EMF_DECLARE(BOOL) DeleteDC ( HDC context )
  {
   ...
   */
  EMF_DECLARE(HDC) CreateEnhMetaFileA ( HDC referenceContext, LPCSTR filename, const RECT* size,
			   LPCSTR description )
  {
   ...
   * \return handle to a metafile device context.
   */
  EMF_DECLARE(HDC) CreateEnhMetaFileW ( HDC referenceContext, LPCWSTR filename,
   ...
   * \return handle to a metafile device context.
   */
  EMF_DECLARE(HDC) CreateEnhMetaFileWithFILEA ( HDC referenceContext, ::FILE* fp,
   ...
   * \return handle to a metafile device context.
   */
  EMF_DECLARE(HDC) CreateEnhMetaFileWithFILEW ( HDC referenceContext, ::FILE* fp,
				   const RECT* size, LPCWSTR description )
  {
   ...
   */
  EMF_DECLARE(HMETAFILE) CreateMetaFileA ( LPCSTR filename )
  {
   ...
   * \return a handle to the metafile.
   */
  EMF_DECLARE(HENHMETAFILE) CloseEnhMetaFile ( HDC context )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return a handle to the metafile.
   */
  EMF_DECLARE(HMETAFILE) CloseMetaFile ( HDC context )
  {
   ...
   */
  EMF_DECLARE(BOOL) DeleteEnhMetaFile ( HENHMETAFILE metafile )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
   ...
   * \return true if metafile successfully deleted.
   */
  EMF_DECLARE(BOOL) DeleteMetaFile ( HMETAFILE metafile )
  {
   ...
   */
  EMF_DECLARE(HENHMETAFILE) GetEnhMetaFileA ( LPCSTR filename )
  {
    // All this does is promote the ASCII strings to UNICODE (after a fashion)
   ...
   * \return metafile handle.
   */
  EMF_DECLARE(HENHMETAFILE) GetEnhMetaFileW ( LPCWSTR filename )
  {
    if ( filename == 0 || *filename == 0 ) return 0;
   ...
   */
  EMF_DECLARE(BOOL) PlayEnhMetaFile ( HDC context, HENHMETAFILE metafile,
			 const RECT* /*frame*/ )
  {
   ...
   */
  EMF_DECLARE(BOOL) MoveToEx ( HDC context, INT x, INT y, LPPOINT point )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(BOOL) LineTo ( HDC context, INT x, INT y )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(HGDIOBJ) GetStockObject ( INT obj )
  {
   ...
   */
  EMF_DECLARE(HGDIOBJ) SelectObject ( HDC context, HGDIOBJ obj )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(INT) GetObjectA ( HGDIOBJ obj, INT size, LPVOID buffer )
  {
    EMF::GRAPHICSOBJECT* gobj =
      dynamic_cast<EMF::GRAPHICSOBJECT*>( EMF::globalObjects.find( obj ) );
   ...
   */
  EMF_DECLARE(BOOL) DeleteObject ( HGDIOBJ obj )
  {
   ...
   */
  EMF_DECLARE(BOOL) SetViewportOrgEx ( HDC context, INT x, INT y, LPPOINT point )
  {
    (void)point;
   ...
   */
  EMF_DECLARE(BOOL) GetViewportOrgEx ( HDC context, LPPOINT point )
  {
    if ( point != 0 ) {
      EMF::METAFILEDEVICECONTEXT* dc =
	dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find(context));
   ...
   */
  EMF_DECLARE(BOOL) SetWindowOrgEx ( HDC context, INT x, INT y, LPPOINT point )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(BOOL) GetWindowOrgEx ( HDC context, LPPOINT point )
  {
    if ( point != 0 ) {
      EMF::METAFILEDEVICECONTEXT* dc =
	dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find(context));
   ...
   */
  EMF_DECLARE(BOOL) SetViewportExtEx ( HDC context, INT cx, INT cy, LPSIZE size )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if viewport size successfully set.
   */
  EMF_DECLARE(BOOL) ScaleViewportExtEx ( HDC context, INT x_num, INT x_den,
			    INT y_num, INT y_den, LPSIZE size )
  {
    ...
    INT num{0};
    if (my__builtin_smul_overflow( dc->viewport_ext.cx, x_num, &num ) ) {
      return FALSE;
    }
    ...
    INT x_ext{ num / x_den };
    if (my__builtin_smul_overflow( dc->viewport_ext.cy, y_num, &num ) ) {
      return FALSE;
    }
   ...
   */
  EMF_DECLARE(BOOL) GetViewportExtEx ( HDC context, LPSIZE size )
  {
    if ( size != 0 ) {
      EMF::METAFILEDEVICECONTEXT* dc =
	dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find(context));
   ...
   */
  EMF_DECLARE(BOOL) SetWindowExtEx ( HDC context, INT cx, INT cy, LPSIZE size )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if window size successfully set.
   */
  EMF_DECLARE(BOOL) ScaleWindowExtEx ( HDC context, INT x_num, INT x_den,
			  INT y_num, INT y_den, LPSIZE size )
  {
    // Avoid obvious nonsense results.
    if ( x_num == 0 or x_den == 0 or y_num == 0 or y_den == 0 ) return FALSE;
    ...
    // if it is negative, division must not overflow.
    INT num{0};
    if (my__builtin_smul_overflow( dc->window_ext.cx, x_num, &num ) ) {
      return FALSE;
    }
    if ( num == INT_MIN and x_den == -1 ) {
      return FALSE;
    ...
    INT x_ext{ num / x_den };
    if (my__builtin_smul_overflow( dc->window_ext.cy, y_num, &num ) ) {
      return FALSE;
    }
    if ( num == INT_MIN and y_den == -1 ) {
      return FALSE;
   ...
   */
  EMF_DECLARE(BOOL) GetWindowExtEx ( HDC context, LPSIZE size )
  {
    if ( size != 0 ) {
      EMF::METAFILEDEVICECONTEXT* dc =
	dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find(context));
   ...
   */
  EMF_DECLARE(BOOL) ModifyWorldTransform(HDC context, const XFORM *transform, DWORD mode )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(BOOL) SetWorldTransform(HDC context, const XFORM *transform )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(HPEN) CreatePen ( INT style, INT width, COLORREF color )
  {
    LOGPEN lpen;
   ...
   * \return handle of new PEN graphics object.
   */
  EMF_DECLARE(HPEN) ExtCreatePen ( DWORD style, DWORD width, const LOGBRUSH* brush,
   ...
   */
  EMF_DECLARE(HPEN) CreatePenIndirect ( const LOGPEN* lpen )
  {
   ...
   */
  EMF_DECLARE(HBRUSH) CreateBrushIndirect ( const LOGBRUSH* lbrush )
  {
   ...
   * \return handle to BRUSH graphics object.
   */
  EMF_DECLARE(HBRUSH) CreateSolidBrush ( COLORREF color )
  {
    LOGBRUSH lbrush;
   ...
   */
  EMF_DECLARE(UINT) SetTextAlign ( HDC context, UINT alignment )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(COLORREF) SetTextColor ( HDC context, COLORREF color )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(COLORREF) SetBkColor ( HDC context, COLORREF color )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(INT) SetBkMode ( HDC context, INT mode )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(INT) SetMapMode ( HDC context, INT mode )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(HFONT) CreateFontA ( INT height, INT width, INT escapement, INT orientation,
   ...
   * \return handle of font.
   */
  EMF_DECLARE(HFONT) CreateFontW ( INT height, INT width, INT escapement, INT orientation,
		      INT weight, DWORD italic, DWORD underline, DWORD strike_out,
		      DWORD charset, DWORD out_precision, DWORD clip_precision,
   ...
   */
  EMF_DECLARE(HFONT) CreateFontIndirectW ( const LOGFONTW* lfont )
  {
   ...
   * \return handle of FONT object.
   */
  EMF_DECLARE(HFONT) CreateFontIndirectA ( const LOGFONTA* lfonta )
  {
    LOGFONTW lfontw;
   ...
   */
  EMF_DECLARE(BOOL) TextOutA ( HDC context, INT x, INT y, LPCSTR string, INT count )
  {
   ...
   */
  EMF_DECLARE(BOOL) ExtTextOutA ( HDC context, INT x, INT y, UINT flags,
   ...
   * \return true if text was successfully rendered.
   */
  EMF_DECLARE(BOOL) ExtTextOutW ( HDC context, INT x, INT y, UINT flags,
   ...
   * \return true if text was successfully rendered.
   */
  EMF_DECLARE(BOOL) TextOutW ( HDC context, INT x, INT y, LPCWSTR string, INT count )
  {
   ...
   */
  EMF_DECLARE(BOOL) Arc ( HDC context, INT left, INT top, INT right, INT bottom, INT xstart,
   ...
   * \return true if arc was successfully rendered.
   */
  EMF_DECLARE(BOOL) ArcTo ( HDC context, INT left, INT top, INT right, INT bottom, INT xstart,
	       INT ystart, INT xend, INT yend )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(BOOL) Rectangle ( HDC context, INT left, INT top, INT right, INT bottom )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(BOOL) Ellipse ( HDC context, INT left, INT top, INT right, INT bottom )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(BOOL) PolyBezier ( HDC context, const POINT* points, DWORD n )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if Bezier curve is successfully rendered.
   */
  EMF_DECLARE(BOOL) PolyBezier16 ( HDC16 context, const POINT16* points, INT16 n )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(UINT) GetEnhMetaFileHeader( HENHMETAFILE metafile, const UINT sizeof_enhmetaheader,
   ...
   */
  EMF_DECLARE(INT) GetDeviceCaps ( HDC context, INT capability )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(BOOL) Polyline ( HDC context, const POINT* points, INT n )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if polyline is successfully rendered.
   */
  EMF_DECLARE(BOOL) Polyline16 ( HDC context, const POINT16* points, INT16 n )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(BOOL) Polygon ( HDC context, const POINT* points, INT n )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if polygon is successfully rendered.
   */
  EMF_DECLARE(BOOL) Polygon16 ( HDC context, const POINT16* points, INT16 n )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(BOOL) PolyPolygon ( HDC context, const POINT* points, const INT* counts,
		     UINT polygons )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if the polygons are successfully rendered.
   */
  EMF_DECLARE(BOOL) PolyPolygon16 ( HDC context, const POINT16* points, const INT* counts,
		       UINT16 polygons )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(INT) SetPolyFillMode ( HDC context, INT mode )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if successful.
   */
  EMF_DECLARE(BOOL) FillPath ( HDC context )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if successful.
   */
  EMF_DECLARE(BOOL) StrokePath ( HDC context )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if successful.
   */
  EMF_DECLARE(BOOL) StrokeAndFillPath ( HDC context )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if Bezier curve is successfully rendered.
   */
  EMF_DECLARE(BOOL) PolyBezierTo ( HDC context, const POINT* points, DWORD n )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if Bezier curve is successfully rendered.
   */
  EMF_DECLARE(BOOL) PolyBezierTo16 ( HDC context, const POINT16* points, INT16 n )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if Polyline is successfully rendered.
   */
  EMF_DECLARE(BOOL) PolylineTo ( HDC context, const POINT* points, DWORD n )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if Polyline is successfully rendered.
   */
  EMF_DECLARE(BOOL) PolylineTo16 ( HDC context, const POINT16* points, INT16 n )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if successful.
   */
  EMF_DECLARE(BOOL) BeginPath ( HDC context )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if successful.
   */
  EMF_DECLARE(BOOL) EndPath ( HDC context )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return true if successful.
   */
  EMF_DECLARE(BOOL) CloseFigure ( HDC context )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(INT) SaveDC (HDC context )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   * \return number of save'd contexts?
   */
  EMF_DECLARE(INT) RestoreDC (HDC context, INT n )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
   ...
   */
  EMF_DECLARE(INT) SetMetaRgn (HDC context )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
    ...
    */
   EMF_DECLARE(BOOL) SetMiterLimit ( HDC context, FLOAT eNewLimit, PFLOAT peOldLimit )
   {
      EMF::METAFILEDEVICECONTEXT* dc =
         dynamic_cast<EMF::METAFILEDEVICECONTEXT*>( EMF::globalObjects.find( context ) );
      if ( dc == 0 ) return FALSE;
   ...
   */
  EMF_DECLARE(COLORREF) SetPixel ( HDC context, INT x, INT y, COLORREF color )
  {
    EMF::METAFILEDEVICECONTEXT* dc =
      dynamic_cast<EMF::METAFILEDEVICECONTEXT*>(EMF::globalObjects.find( context ));
